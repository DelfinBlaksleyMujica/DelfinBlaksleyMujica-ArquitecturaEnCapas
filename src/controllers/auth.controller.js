//Servicios
const {} = require("../services/auth.service");
...
module.exports = { getRegistroController ,getInicioSesionController , getLoginController , getLogoutController , postSignup , postLoginController };