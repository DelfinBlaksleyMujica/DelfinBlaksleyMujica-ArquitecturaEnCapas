//Servicios
const { getCarts , saveNewCart , getCartById , deleteCart , addProduct , removeProduct } = require("../services/carts.service");
...
const postNewCartController = async (req, res) => {
    ...
    try {
        logger.info(`Ruta ${ method } ${ url } visitada`);
        const nuevoCarrito = await saveNewCart();
...
const postProductInCartController = async (req, res) => {
    ...
    try {
        ...
        if (req.params) {
            ...
            const newProduct = await addProduct( producto )
...
const deleteProductFromCartController = async (req, res) => {
    ...
    try {
        ...
        if (req.params) {
            ...
            const removedProd = await removeProduct( id , idProd );
