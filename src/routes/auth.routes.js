...
const { getRegistroController , getInicioSesionController , getLoginController , getLogoutController , postSignup , postLoginController } = require("../controllers/auth.controller");
